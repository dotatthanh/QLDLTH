...
use App\Http\Controllers\TvSystemIntroductionController;
...
Route::middleware(['auth'])->group(function () {
	...
	Route::resource('tv-system-introductions', TvSystemIntroductionController::class);
	Route::get('/system-introduction', [TvSystemIntroductionController::class, 'systemIntroduction'])->name('tv-system-introductions.system-introduction');
	...
	Route::post('/station/import-excel', [StationController::class, 'importExcel'])->name('stations.import-excel');
	Route::get('/station/system-tree', [StationController::class, 'systemTree'])->name('station.system-tree');
	Route::post('/station/get-station-child-list', [StationController::class, 'getStationChildList']);
	Route::post('/station/get-station-by-region', [StationController::class, 'getStationByRegion']);
