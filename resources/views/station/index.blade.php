                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('stations.index') }}">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-12">
                                            <a href="{{ route('station.system-tree') }}" class="text-white btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-chart-tree"></i> Quản lý trạm</a>
                                        </div>
                                    </div>
                                </form>
